...
<div id="whatsapp-widget" class="whatsapp-widget {$widget_position} {$widget_size} {if $dark_mode}dark{/if} {if $consent_required && !$has_consent}consent-required{/if}" 
     data-phone="{$phone|escape:'html':'UTF-8'}" 
     data-message="{$message|escape:'html':'UTF-8'}" 
     data-page-type="{$page_type|escape:'html':'UTF-8'}"
     {if $working_hours_enabled}data-working-hours="{$working_hours|@json_encode|escape:'html':'UTF-8'}"{/if}
     {if $consent_required}data-consent-cookies="{$consent_cookies|escape:'html':'UTF-8'}"{/if}
     role="button" 
     tabindex="0" 
     aria-label="{if $product_name}{$product_name|truncate:40:'...'|escape:'html':'UTF-8'} - {/if}{l s='Chat on WhatsApp' mod='whatsappwidget'}"
    ...
    {else}
        {if $working_hours_enabled && !$is_working_hours}
            ...
            <div class="whatsapp-offline">
                ...
                <div class="offline-content">
                    <p class="offline-text">{$offline_message|escape:'html':'UTF-8'}</p>
        ...
        {else}
            ...
            <div class="whatsapp-button" 
                 ...
                 role="button"
                 tabindex="0"
                 aria-label="{if $product_name}{$product_name|truncate:40:'...'|escape:'html':'UTF-8'} - {/if}{l s='Start WhatsApp chat' mod='whatsappwidget'}">
